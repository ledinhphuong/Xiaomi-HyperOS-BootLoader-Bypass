...
class ADB {
    ...
    public function refreshDeviceList() {
        ...
        // Sample output of "devices -l":
        // Darwin:
        // d68b986                device 1-1 product:spes_global model:2201117TG device:spes transport_id:1
        // Windows:
        // d68b986                device product:spes_global model:2201117TG device:spes transport_id:4
                ...
                switch ($device[1]) {
                    ...
                    case self::CONNECT_TYPE_RECOVERY:
                        if (PHP_OS_FAMILY === "Darwin")
                            $transport = str_replace("transport_id:", "", $device[6]);
                        else
                    ...
                    case self::CONNECT_TYPE_RESCUE:
                        ...
                        if (PHP_OS_FAMILY === "Darwin")
                            $temp["transport"] = str_replace("transport_id:", "", $device[6]);
                        else
